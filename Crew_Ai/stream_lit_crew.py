...
search_tool = SerperDevTool(api_key="3efe53bf8044f01c84e9c0d43a252fc74dc64a7")
load_dotenv()

# Streamlit page config
st.set_page_config(
    page_title="Content Reseracher &  Writer", page_icon="📰", layout="wide"
)
...
def generate_content(topic):
    llm = completion(model="ollama/llama3.2:latest", api_base="http://localhost:11434")
